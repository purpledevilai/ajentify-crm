  ...
  if (!deal) {
    return (
      <div className="flex flex-col items-center justify-center py-16">
        ...
        <Link
          href="/deals"
          className="mt-4 inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground shadow-xs hover:bg-primary/90"
        >
          Back to Deals
        </Link>
      </div>
